...
class JStatementExpressions extends JStatement {
    ...
    public JStatementExpressions(int line, ArrayList<JStatement> statements) {
        super(line);
    ...
    public JStatementExpressions analyze(Context context) {
    ...
    public void writeToStdOut(PrettyPrinter p) {
        p.printf("<JStatementExpressions line=\"%d\">\n", line());
        if (context != null) {
            p.indentRight();
        ...
        p.printf("</JStatementExpressions>\n");
    }
